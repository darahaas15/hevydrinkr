...
export function ActiveSessionBanner() {
  ...
  return (
    ...
    >
      <div className="max-w-lg mx-auto rounded-2xl p-3 flex items-center gap-3 shadow-lg" style={{ background: 'var(--popover-strong-bg)', border: '1px solid rgba(20,184,166,0.2)', backdropFilter: 'blur(12px)' }}>
