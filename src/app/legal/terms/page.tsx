  ...
  return (
    <div className="min-h-dvh bg-background text-foreground">
      ...
      <div className="px-5 py-6 max-w-lg mx-auto space-y-6 text-sm text-muted-foreground leading-relaxed">
        ...
        <section>
          <h2 className="text-base font-semibold text-foreground mb-2">3. Purpose & Disclaimer</h2>
        ...
        <section>
          <h2 className="text-base font-semibold text-foreground mb-2">5. User-Generated Content</h2>
        ...
        <section>
          <h2 className="text-base font-semibold text-foreground mb-2">6. Account Termination</h2>
