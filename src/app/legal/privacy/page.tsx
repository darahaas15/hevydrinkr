  ...
  return (
    <div className="min-h-dvh bg-background text-foreground">
      ...
      <div className="px-5 py-6 max-w-lg mx-auto space-y-6 text-sm text-muted-foreground leading-relaxed">
        <p className="text-[10px] text-muted uppercase tracking-wider">Last updated: April 2026</p>

        <section>
          <h2 className="text-base font-semibold text-foreground mb-2">1. Information We Collect</h2>
          <p>When you use Drinkr, we collect:</p>
          <ul className="list-disc list-inside mt-2 space-y-1 text-fg-secondary">
            <li><strong className="text-muted-foreground">Account information:</strong> email address, username, display name, date of birth (used to verify you meet the minimum age)</li>
            <li><strong className="text-muted-foreground">Profile data:</strong> avatar photo, bio, gender, height, and weight (used only on your own device to estimate your BAC)</li>
            <li><strong className="text-muted-foreground">Session data:</strong> drink entries, venues (user-entered text), session times, photos you choose to upload</li>
            <li><strong className="text-muted-foreground">Social data:</strong> follows, likes, comments, group memberships</li>
            <li><strong className="text-muted-foreground">Device data:</strong> push notification tokens for delivering notifications</li>
          </ul>
        ...
        <section>
          <h2 className="text-base font-semibold text-foreground mb-2">4. Data Sharing & Visibility</h2>
        ...
        <section>
          ...
          <ul className="list-disc list-inside mt-2 space-y-1 text-fg-secondary">
            <li><strong className="text-muted-foreground">Access</strong> your personal data through your profile and session history</li>
            <li><strong className="text-muted-foreground">Correct</strong> your data through the Settings page</li>
            <li><strong className="text-muted-foreground">Delete</strong> your account and all associated data through Settings &gt; Delete Account</li>
            <li><strong className="text-muted-foreground">Withdraw consent</strong> for push notifications at any time through Settings</li>
          </ul>
        </section>
        ...
        <section>
          <h2 className="text-base font-semibold text-foreground mb-2">8. Reporting & Blocking</h2>
